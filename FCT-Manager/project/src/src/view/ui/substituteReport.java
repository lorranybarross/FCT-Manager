 ...
 * @author becelli
 */
public class substituteReport extends javax.swing.JFrame {
    private Controller c;

    /**
     * Creates new form generalReportWindow
     */
    public substituteReport(Controller c) {
        this.c = c;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        outputText.setText(c.substituteReport());
        ...
        Title.setText("Docentes Substitutos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(substituteReport.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
