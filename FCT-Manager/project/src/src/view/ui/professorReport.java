 ...
 * @author becelli
 */
public class professorReport extends javax.swing.JFrame {
    private Controller c;

    /**
     * Creates new form generalReportWindow
     */
    public professorReport(Controller c) {
        this.c = c;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(professorReport.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
