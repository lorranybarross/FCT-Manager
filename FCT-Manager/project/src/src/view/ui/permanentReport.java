 ...
 * @author becelli
 */
public class permanentReport extends javax.swing.JFrame {
    private Controller c;

    /**
     * Creates new form generalReportWindow
     */
    public permanentReport(Controller c) {
        this.c = c;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        outputText.setText(c.permanentReport());
        ...
        Title.setText("Docentes Efetivos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(permanentReport.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
